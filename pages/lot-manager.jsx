...
function LotManager() {
  ...
  const filterBtnVariant = (id) => (isActiveFilter(id) ? 'default' : 'outline');

  return (
    <>
      <div className="min-h-screen space-y-4">
        {/* Sticky toolbar (filters + search) */}
        <div className="sticky top-0 z-20 py-3 bg-gray-50">
          <div className="md:flex items-center justify-between md:space-x-2 space-y-3 md:space-y-0">
            ...
            <div className="relative w-full md:w-[400px]">
              ...
              <input
                ...
                className="w-full h-12 bg-white rounded-full px-12 border border-gray-200"
              />
              {search !== '' && (
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="space-x-2">
                <Button
                  ...
                  variant={showClosedReservations ? 'default' : 'outline'}
                  size="sm"
                >
...
LotManager.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;

// Optional: mark this page as protected
LotManager.auth = true;
...
function VehicleCard({
  ...
  return (
    <div
      ...
      className="rounded-2xl border border-gray-200 overflow-hidden bg-white w-full grid grid-cols-3 h-[140px]"
      {...rest}
    >
      <div className=" relative">
        <div className="absolute top-0 left-0 p-1">
          <span className="ml-1 inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold bg-black  ">
      ...
      <div className="col-span-2 w-full">
        ...
        <div className="w-full overflow-hidden overflow-x-auto p-3">
          {eventsToShow.length > 0 && !vehicle.currentTrip && (
            <div
              className={`grid ${
          ...
          {vehicle.currentTrip && <TripCard vehicle={vehicle} />}
        </div>
      </div>
    </div>
  );
